...
.container{width:100%;max-width:1220px;margin:0 auto;padding:24px 20px 70px}
...
.mock{border:1px solid #c7d2fe;border-radius:18px;overflow:hidden;background:#fff;margin:14px 0}.mock-head{display:flex;gap:8px;align-items:center;justify-content:space-between;padding:12px 14px;background:#f8fafc;border-bottom:1px solid var(--line)}.mock-tabs{display:flex;gap:7px;flex-wrap:wrap}.mock-tab{min-height:26px;border-radius:999px;background:#e0e7ff;color:#3730a3;padding:4px 10px;font-size:12px;font-weight:850}.mock-body{padding:15px;display:grid;gap:12px}.mock-kpis{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}.mock-kpi{min-width:0;border:1px solid var(--line);border-radius:12px;padding:10px;background:#fff}.mock-kpi span{display:block;color:var(--muted);font-size:11px;text-transform:uppercase;font-weight:850}.mock-kpi b{font-size:20px}.mock-chart{height:120px;border-radius:12px;background:linear-gradient(135deg,#eef2ff,#ecfeff);border:1px solid #dbeafe;display:flex;align-items:end;gap:8px;padding:12px;overflow:hidden}.bar{width:18px;min-width:10px;border-radius:8px 8px 0 0;background:linear-gradient(180deg,var(--brand),var(--brand2))}.mock-list{display:grid;gap:8px}.mock-row{display:grid;grid-template-columns:120px minmax(0,1fr) 60px;gap:10px;align-items:center;font-size:12px;color:#475569}.track{height:9px;background:#e2e8f0;border-radius:999px;overflow:hidden}.fill{height:100%;background:linear-gradient(90deg,var(--brand),var(--brand2));border-radius:999px}
...
@media(max-width:1024px){.container{padding-left:18px;padding-right:18px}.layout{grid-template-columns:220px minmax(0,1fr);gap:14px}.toc a{font-size:13px;padding:9px 10px}.hero h1{font-size:36px}.panel{padding:20px}}
@media(max-width:900px){.layout,.grid,.three{grid-template-columns:1fr}.toc{position:static;max-height:none;overflow:visible;padding:0}.hero h1{font-size:32px}.topbar{align-items:flex-start;flex-direction:column}.mock-kpis{grid-template-columns:repeat(2,minmax(0,1fr))}table{min-width:640px}}
@media(max-width:640px){body{line-height:1.58}.container{padding:16px 14px 56px}.brand{font-size:18px}.brand img{width:40px;height:40px}.actions{width:100%}.btn,.ghost{width:100%;min-height:44px}.hero{margin-top:10px}.hero h1{font-size:28px}.hero p{font-size:15px}.panel{border-radius:14px;padding:17px;margin-bottom:13px}.panel h2{font-size:21px}.panel h3{font-size:16px}.panel p,.panel li{font-size:14px}.toc{grid-template-columns:1fr 1fr;gap:7px}.toc a{border-radius:10px;font-size:12px;padding:8px 9px}.mock-head{align-items:flex-start;flex-direction:column}.mock-body{padding:12px}.mock-kpis{grid-template-columns:1fr}.mock-chart{height:96px;gap:5px;padding:10px}.mock-row{grid-template-columns:1fr;gap:6px}.table-wrap{margin-left:-2px;margin-right:-2px}table{min-width:560px}th,td{padding:9px 10px}}
@media(max-width:380px){.container{padding-left:10px;padding-right:10px}.hero h1{font-size:25px}.toc{grid-template-columns:1fr}.panel{padding:15px}.card{padding:13px}table{min-width:520px}}
